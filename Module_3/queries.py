QUERIES = [
    ...
    {
        "number": 10,
        "question": "How many entries for students applied for Fall 2026 term for Stanford Univerity Masters program per acceptance status? ",
        "sql": """
           SELECT
                CASE
    ...
    {
        "number": 11,
        "question": "For students applied for Fall 2026 term for Stanford Univerity Masters program and got accepted, what is the percentage of international student?",
        "sql": """
           SELECT
            ROUND(
                100.0 * SUM(
