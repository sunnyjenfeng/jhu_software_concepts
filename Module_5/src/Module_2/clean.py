"""This script loads the scraped data, and cleans data"""
...
def _extract_decision_date(text):
    """ This function extracts the decision date"""
    if text is None:
        return None
...
def _extract_term(text):
    """ This function extracts the term"""
    text = text or ""
...
def _extract_student_type(text):
    """ This function extracts student type--internaltional or US"""
    if text is None:
        return None
    text_lower = text.lower()
...
def _extract_gre_score(text):
    """ This function extracts GRE score"""
    text = text or ""
...
def _extract_gre_v(text):
    """ This function extracts GRE V score"""
    text = text or ""
...
def _extract_gre_aw(text):
    """ This function extracts GRE AW score"""
    text = text or ""
...
def main():
    """
    Main function to load data, clean data and save data
    """
